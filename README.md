...
Description: SKU configuration for the SQL Instance Pool. The following properties can be specified:
...
### <a name="input_maintenance_configuration_id"></a> [maintenance\_configuration\_id](#input\_maintenance\_configuration\_id)
